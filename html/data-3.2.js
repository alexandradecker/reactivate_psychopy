...
class ExperimentHandler extends PsychObject {
	...
	async save({
		...
		else if (this._psychoJS.config.experiment.saveFormat === ExperimentHandler.SaveFormat.DATABASE)
		{
			...
			console.log(this._psychoJS.getEnvironment());
			console.log('data line 139');
// 			console.log(ExperimentHandler.Environment.SERVER);
			console.log('data line 141');
// 			console.log(this._psychoJS.config.experiment.status);
			console.log('data line 143');
// 			console.log(!this._psychoJS._serverMsg.has('__pilotToken'));
