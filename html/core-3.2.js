...
class PsychoJS
{
	...
	async quit({ message, isCompleted = false } = {}) {
		...
		try {
			...
			console.log(PsychoJS.Environment.SERVER);
			if (this.getEnvironment() === PsychoJS.Environment.SERVER)
			{
