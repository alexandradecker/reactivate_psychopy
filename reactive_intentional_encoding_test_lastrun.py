...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/alexandradecker/Dropbox/Projects/reactivate/reactive_intentional_encoding_test_lastrun.py',
...
# Initialize components for Routine "trials_attention_encoding"
trials_attention_encodingClock = core.Clock()
...
incidental_image1__2 = visual.ImageStim(
    win=win,
    name='incidental_image1__2', 
    image='sin', mask=None,
    ori=0, pos=(-0.3, 0), size=(0.3, 0.3),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
incidental_image2__2 = visual.ImageStim(
    win=win,
    name='incidental_image2__2', 
    image='sin', mask=None,
    ori=0, pos=(0.3, 0), size=(0.3, 0.3),
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
...
text_20 = visual.TextStim(win=win, name='text_20',
    text='Yes',
    font='Helvetica',
    pos=(0.2, -0.37), height=0.03, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-4.0);
...
# set up handler to look after randomisation of conditions etc
trials_15 = data.TrialHandler(nReps=5, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('trialorder/block_order.xlsx'),
...
for thisTrial_15 in trials_15:
    ...
    # set up handler to look after randomisation of conditions etc
    trials_14 = data.TrialHandler(nReps=5, method='sequential', 
        extraInfo=expInfo, originPath=-1,
    ...
    for thisTrial_14 in trials_14:
        ...
        # ------Prepare to start Routine "trials_attention_encoding"-------
        # update component parameters for each repeat
        image_17.setImage(Arrow_direction)
        key_resp_11.keys = []
        key_resp_11.rt = []
        incidental_image1__2.setImage(incidental_image1)
        incidental_image2__2.setImage(incidental_image2)
        # keep track of which components have finished
        trials_attention_encodingComponents = [image_17, key_resp_11, incidental_image1__2, incidental_image2__2]
        for thisComponent in trials_attention_encodingComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        t = 0
        _timeToFirstFrame = win.getFutureFlipTime(clock="now")
        trials_attention_encodingClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
        frameN = -1
        continueRoutine = True
        
        # -------Run Routine "trials_attention_encoding"-------
        while continueRoutine:
            # get current time
            t = trials_attention_encodingClock.getTime()
            tThisFlip = win.getFutureFlipTime(clock=trials_attention_encodingClock)
            tThisFlipGlobal = win.getFutureFlipTime(clock=None)
            frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
            # update/draw components on each frame
            ...
            if key_resp_11.status == STARTED and not waitOnFlip:
                theseKeys = key_resp_11.getKeys(keyList=['j', 'f'], waitRelease=False)
                if len(theseKeys):
                    theseKeys = theseKeys[0]  # at least one key was pressed
            ...
            # *incidental_image1__2* updates
            if incidental_image1__2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                incidental_image1__2.frameNStart = frameN  # exact frame index
                incidental_image1__2.tStart = t  # local t and not account for scr refresh
                incidental_image1__2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(incidental_image1__2, 'tStartRefresh')  # time at next scr refresh
                incidental_image1__2.setAutoDraw(True)
            if incidental_image1__2.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > incidental_image1__2.tStartRefresh + 3-frameTolerance:
                    # keep track of stop time/frame for later
                    incidental_image1__2.tStop = t  # not accounting for scr refresh
                    incidental_image1__2.frameNStop = frameN  # exact frame index
                    win.timeOnFlip(incidental_image1__2, 'tStopRefresh')  # time at next scr refresh
                    incidental_image1__2.setAutoDraw(False)
            
            # *incidental_image2__2* updates
            if incidental_image2__2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                incidental_image2__2.frameNStart = frameN  # exact frame index
                incidental_image2__2.tStart = t  # local t and not account for scr refresh
                incidental_image2__2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(incidental_image2__2, 'tStartRefresh')  # time at next scr refresh
                incidental_image2__2.setAutoDraw(True)
            if incidental_image2__2.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > incidental_image2__2.tStartRefresh + 3-frameTolerance:
                    # keep track of stop time/frame for later
                    incidental_image2__2.tStop = t  # not accounting for scr refresh
                    incidental_image2__2.frameNStop = frameN  # exact frame index
                    win.timeOnFlip(incidental_image2__2, 'tStopRefresh')  # time at next scr refresh
                    incidental_image2__2.setAutoDraw(False)
        ...
        # -------Ending Routine "trials_attention_encoding"-------
        for thisComponent in trials_attention_encodingComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        ...
        thisExp.nextEntry()
        thisExp.addData('incidental_image1__2.started', incidental_image1__2.tStartRefresh)
        thisExp.addData('incidental_image1__2.stopped', incidental_image1__2.tStopRefresh)
        thisExp.addData('incidental_image2__2.started', incidental_image2__2.tStartRefresh)
        thisExp.addData('incidental_image2__2.stopped', incidental_image2__2.tStopRefresh)
        # the Routine "trials_attention_encoding" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
...
# completed 5 repeats of 'trials_15'
...
thisExp.nextEntry()
thisExp.addData('F_press.started', F_press.tStartRefresh)
thisExp.addData('F_press.stopped', F_press.tStopRefresh)
thisExp.addData('J_press.started', J_press.tStartRefresh)
thisExp.addData('J_press.stopped', J_press.tStopRefresh)
thisExp.addData('left_press.started', left_press.tStartRefresh)
thisExp.addData('left_press.stopped', left_press.tStopRefresh)
thisExp.addData('right_press.started', right_press.tStartRefresh)
thisExp.addData('right_press.stopped', right_press.tStopRefresh)
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if incidental_image1_.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > incidental_image1_.tStartRefresh + 3-frameTolerance:
            # keep track of stop time/frame for later
    ...
    if incidental_image2_.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > incidental_image2_.tStartRefresh + 3-frameTolerance:
            # keep track of stop time/frame for later
...
for thisComponent in practice_incidental_encodingComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('incidental_image1_.started', incidental_image1_.tStartRefresh)
thisExp.addData('incidental_image1_.stopped', incidental_image1_.tStopRefresh)
# check responses
...
thisExp.addData('incidental_image2_.started', incidental_image2_.tStartRefresh)
thisExp.addData('incidental_image2_.stopped', incidental_image2_.tStopRefresh)
